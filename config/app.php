...
return [
    ...
    */
    ...
    'aliases' => [
        ...
        'ProductService' => App\Services\ProductService::class,
        'UserService' => App\Services\UserService::class,
        'BannerService' => App\Services\BannerService::class,
        'WishlistService' => App\Services\WishlistService::class,
        'DashboardService' => App\Services\DashboardService::class,
        'CheckoutService' => App\Services\CheckoutService::class,
    ],
