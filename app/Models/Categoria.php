...
class Categoria extends Model
{
    ...
    public function produtosDisponiveis() { return $this->hasMany(Produto::class)->disponivel(); }
    public function subcategorias() { return $this->hasMany(Categoria::class, 'categoria_pai_id'); }
    public function categoriaPai() { return $this->belongsTo(Categoria::class, 'categoria_pai_id'); }
    ...
    public function scopeOrdenado($query) { return $query->orderBy('ordem')->orderBy('nome'); }
    public function scopePai($query) { return $query->whereNull('categoria_pai_id'); }
    public function scopeFilhas($query, $paiId) { return $query->where('categoria_pai_id', $paiId); }

    public function isAtivo(): bool { return (bool) $this->ativo; }
    public function getContagemProdutos(): int { return $this->produtos()->disponivel()->count(); }
