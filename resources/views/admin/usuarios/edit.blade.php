                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}" id="profile-form">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('cpf') is-invalid @enderror" 
                                           id="cpf" name="cpf" 
                                           value="{{ old('cpf', Auth::user()->cpf_formatado ?? '') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('cnpj') is-invalid @enderror" 
                                           id="cnpj" name="cnpj" 
                                           value="{{ old('cnpj', Auth::user()->cnpj_formatado ?? '') }}" 
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            ...
                            <button type="submit" class="btn btn-primary" id="submit-profile-btn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (cpf) {
        cpf.addEventListener('input', function() { mascaraCPF(this); });
    }

    const cnpj = document.getElementById('cnpj');
    if (cnpj) {
        cnpj.addEventListener('input', function() { mascaraCNPJ(this); });
    }
