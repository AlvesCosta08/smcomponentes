    ...
    <div class="container">
        ...
        <div class="row g-3">
            @foreach($produtosDestaque as $produto)
                @include('produtos.partials.card-home', ['produto' => $produto, 'corBadge' => 'danger', 'corPreco' => 'primary'])
            @endforeach
        </div>
    ...
    <div class="container">
        ...
        <div class="row g-3">
            @foreach($ofertas as $produto)
                @include('produtos.partials.card-home', ['produto' => $produto, 'corBadge' => 'danger', 'corPreco' => 'danger'])
            @endforeach
        </div>
        @if($ofertas->hasPages())
        <div class="row mt-3">
    ...
    <div class="container">
        ...
        <div class="row g-3">
            @foreach($maisVendidos as $produto)
                @include('produtos.partials.card-home', ['produto' => $produto, 'corBadge' => 'warning', 'corPreco' => 'warning'])
            @endforeach
        </div>
...
<style>
    ...
    .carousel-principal .carousel-indicators { margin-bottom: 10px; }
    ...
    .carousel-principal:hover .carousel-control-next { opacity: 1; }
    .carousel-principal .carousel-control-prev { left: 16px; }
    .carousel-principal .carousel-control-next { right: 16px; }
    ...
    .banner-content h1 { font-size: 3rem; line-height: 1.2; letter-spacing: -0.5px; }
    .banner-content .lead { font-size: 1.25rem; opacity: 0.95; }
    ...
    .vantagem-card i { font-size: 2.2rem; }
    .vantagem-card h6 { font-size: 0.8rem; margin-bottom: 2px; }
    .vantagem-card small { font-size: 0.7rem; }
    ...
    /* ✅ Imagem - sempre 180x180, sem distorção */
    ...
    .produto-card-smart .card-body { padding: 10px 12px 12px; }
    ...
    @media (max-width: 992px) {
        .carousel-principal .carousel-item img,
        .carousel-principal .banner-placeholder { height: 350px; }
    ...
    @media (max-width: 768px) {
        .carousel-principal .carousel-item img,
        .carousel-principal .banner-placeholder { height: 250px; }
        .carousel-principal .banner-placeholder h1 { font-size: 1.8rem !important; }
        .carousel-principal .banner-placeholder p { font-size: 0.9rem !important; }
        .carousel-principal .carousel-control-prev,
        .carousel-principal .carousel-control-next { width: 34px; height: 34px; }
        .banner-overlay {
            padding: 1.5rem;
        ...
        .banner-content .lead { font-size: 0.9rem; }
        .banner-content .btn { font-size: 0.9rem !important; padding: 0.6rem 1.8rem !important; }
        .vantagem-card { padding: 0.75rem !important; }
        .vantagem-card i { font-size: 1.5rem; }
        .vantagem-card h6 { font-size: 0.65rem; }
        .vantagem-card small { font-size: 0.6rem; }
        .produto-card-smart .card-img-wrapper,
        .produto-card-smart .card-img-wrapper img,
        .produto-card-smart .card-img-wrapper .placeholder-icon { height: 140px !important; }
        .produto-card-smart .card-title { font-size: 0.75rem; min-height: 32px; }
        .produto-card-smart .btn { font-size: 0.7rem; padding: 4px 8px; }
        .produto-card-smart .card-body { padding: 8px 10px 10px; }
        .produtos-smart h3,
        .ofertas-smart h3,
        .mais-vendidos-smart h3,
        .todos-produtos-smart h3 { font-size: 1.1rem; }
    }

    @media (max-width: 576px) {
        .carousel-principal .carousel-item img,
        .carousel-principal .banner-placeholder { height: 180px; }
        .carousel-principal .banner-placeholder h1 { font-size: 1.2rem !important; }
        .carousel-principal .banner-placeholder p { font-size: 0.7rem !important; }
        .carousel-principal .carousel-control-prev,
        .carousel-principal .carousel-control-next {
            width: 28px; height: 28px; opacity: 1 !important;
        }
        .carousel-principal .carousel-control-prev { left: 6px !important; }
        .carousel-principal .carousel-control-next { right: 6px !important; }
        ...
        .carousel-principal .carousel-indicators button { width: 8px !important; height: 8px !important; }
        .banner-overlay {
            padding: 1rem;
        ...
        .banner-content .btn { font-size: 0.8rem !important; padding: 0.4rem 1.2rem !important; }
        .vantagem-card { padding: 0.5rem !important; }
        .vantagem-card i { font-size: 1.2rem; }
        .vantagem-card h6 { font-size: 0.6rem; }
        .vantagem-card small { font-size: 0.55rem; }
        .produto-card-smart .card-img-wrapper,
        .produto-card-smart .card-img-wrapper img,
        .produto-card-smart .card-img-wrapper .placeholder-icon { height: 110px !important; }
        .produto-card-smart .card-title { font-size: 0.7rem; min-height: 28px; }
        .produto-card-smart .card-body { padding: 6px 8px 8px; }
        .produto-card-smart .btn { font-size: 0.65rem; padding: 3px 6px; }
        .produto-card-smart .card-text { font-size: 0.8rem; }
        .produtos-smart h3,
        .ofertas-smart h3,
        .mais-vendidos-smart h3,
        .todos-produtos-smart h3 { font-size: 0.95rem; }
        .produtos-smart .btn-sm,
        .ofertas-smart .btn-sm,
        .mais-vendidos-smart .btn-sm,
        .todos-produtos-smart .btn-sm { font-size: 0.7rem; padding: 3px 10px; }
        .vantagens-smart .col-6,
        .produtos-smart .col-6,
        .ofertas-smart .col-6,
        .mais-vendidos-smart .col-6,
        .todos-produtos-smart .col-6 { padding: 0 4px; }
