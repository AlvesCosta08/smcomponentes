...
@section('title', 'Confirmar Senha - SM Componentes')
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-body p-4 p-sm-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h4 class="fw-bold mb-1" style="color: #0f172a;">Confirmar senha</h4>
                        <p class="text-muted small">Por segurança, confirme sua senha para continuar</p>
                    </div>
                    ...
                    <div class="text-center mt-4 pt-3 border-top" style="border-color: #e2e8f0 !important;">
                        <a href="{{ route('home') }}" class="text-decoration-none small" style="color: #2563eb;">
                            <i class="bi bi-house me-1"></i> Voltar para a loja
                        </a>
                    </div>
                </div>
            </div>
